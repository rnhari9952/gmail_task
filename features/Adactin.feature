...
When User enter the username 'hariharan' in Login Page
And User enter the password '2345' in Login Page
And User Click the signin Button in Login Page
Then User Verify the username 'Hello hariharan!' displayed in the header
...
Scenario: User able to select the hotel booking and verify the name
When User able to select the location
And User able to select the hotel
And User able to select the Room type
And User able to select the Number of rooms
